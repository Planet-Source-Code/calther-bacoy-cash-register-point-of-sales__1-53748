...
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drptSales 
   Caption         =   "Lao Enterprises"
   ClientHeight    =   11115
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15240
   Icon            =   "drptSales.dsx":0000
   MDIChild        =   -1  'True
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Caption         =   "Aban's Cellphone Trading Centre River Bank Mall,Marikina City          Tel No. 02-437-8119"
      EndProperty
      ItemType1       =   7
...
If MsgBox("Are you sure Printing already done?", vbQuestion + vbYesNo) = vbYes Then
    
    
    Cancel = 0
    mdiMain.Toolbar1.Visible = True
    Sales.btnStart.Enabled = True
    Sales.btnPrint.Enabled = False
    Sales.btnSave.Enabled = False
    Call Sales.Cleartext
    Sales.txtAmount.Text = ""
    Sales.txtDiscount.Text = ""
    Sales.txtInvoiceNo.Text = ""
    Sales.lvprod.ListItems.Clear
    Unload Me
